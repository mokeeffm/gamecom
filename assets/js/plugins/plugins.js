    ...
    i.prototype = {
        ...
        watch: function() {
            ...
            t(window).on("resize scroll", (function() {
                i.isIn() && !1 === n && (i.cb.call(i.$el, "entered"), n = !0), !0 !== n || i.isIn() || (i.cb.call(i.$el, "leaved"), n = !1)
            }))
        }
...
! function(t) {
    ...
    s.prototype = {
        ...
        typewrite: function(t, s) {
            if (!0 !== this.stop) {
                ...
                o.timeout = setTimeout(function() {
                    ...
                    if ("^" === r.charAt(0)) {
                        var i = 1;
                        /^\^\d+/.test(r) && (i += (r = /\d+/.exec(r)[0]).length, e = parseInt(r)), t = t.substring(0, s) + t.substring(s + i)
                    }
                    ...
                    o.timeout = setTimeout(function() {
                        if (s === t.length) o.options.onStringTyped(o.arrayPos), (o.arrayPos !== o.strings.length - 1 || (o.options.callback(), o.curLoop++, !1 !== o.loop && o.curLoop !== o.loopCount)) && (o.timeout = setTimeout(function() {
                            o.backspace(t, s)
                        }, o.backDelay));
                        else {
                            o.arrayPos, o.stopNum = 1;
        ...
        return this.each(function() {
            var o = t(this),
                r = o.data("typed");
            r || o.data("typed", r = new s(this, "object" == typeof e && e)), "string" == typeof e && r[e]()
        })
    }, t.fn.typed.defaults = {
